...
export default async function TrainerDetailPage({
  ...
  return (
    <div>
      ...
      <div className="mt-4 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
        <div>
        ...
        <aside>
          <Suspense fallback={null}>
            <CommentSection entityType="trainer" entityId={tr_no} entityName={`${trainer.tr_name} 조교사`} />
          </Suspense>
        </aside>
      </div>
    </div>
