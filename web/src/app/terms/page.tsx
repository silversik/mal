...
export const metadata: Metadata = {
  title: "이용약관",
  description:
    "mal.kr 이용약관입니다. 서비스 이용 규칙, 데이터 출처, 면책 사항을 확인하세요.",
    ...
    <div className="max-w-2xl mx-auto px-4 py-10 space-y-8">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-foreground/90">
          이 약관은 mal.kr(이하 "서비스")이 제공하는 경마 데이터 아카이빙·분석 서비스의 이용
          조건과 절차, 운영자와 이용자의 권리·의무를 규정함을 목적으로 합니다.
        </p>
      </section>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold">제4조 (데이터 출처 및 정확성)</h2>
        <p className="text-sm leading-relaxed text-foreground/90">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold">제5조 (이용자 의무)</h2>
        <ul className="text-sm leading-relaxed text-foreground/90 space-y-1 list-disc list-inside">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold">제6조 (서비스 변경 및 중단)</h2>
        <p className="text-sm leading-relaxed text-foreground/90">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold">제7조 (면책 조항)</h2>
        <p className="text-sm leading-relaxed text-foreground/90">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold">제8조 (준거법 및 분쟁 해결)</h2>
        <p className="text-sm leading-relaxed text-foreground/90">
